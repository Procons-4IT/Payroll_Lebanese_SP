...
#Region "Databind"
    Private Sub Databind(ByVal aform As SAPbouiCOM.Form)
        Try
            ...
            dtTemp.ExecuteQuery("Select *,Code 'Ref' from [@Z_PAY11] where U_Z_Empid='" & oApplication.Utilities.getEdittextvalue(aform, "4") & "'  order by Code")
    ...
    Private Function AddtoUDT1(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If strESocial <> "" Then
                ...
                strETax = oGrid.DataTable.GetValue(4, intRow)
                ...
                If oUserTable.GetByKey(strCode) = False Then
                    ...
                    If strETax <> "" And strETax IsNot Nothing Then
                        Try
                            oUserTable.UserFields.Fields.Item("U_Z_EndDate").Value = oGrid.DataTable.GetValue(4, intRow)
                        Catch ex As Exception
