Public Class clsReligion
    ...
    Private Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_Religion) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_Religion, frm_Religion)
...
#Region "Databind"
    Private Sub Databind(ByVal aform As SAPbouiCOM.Form)
        Try
            ...
            dtTemp.ExecuteQuery("Select Code,Name,U_Z_FrgnName from [@Z_Religion] order by Code")
...
#Region "FormatGrid"
    Private Sub Formatgrid(ByVal agrid As SAPbouiCOM.Grid)
        ...
        agrid.Columns.Item(0).TitleObject.Caption = "Religion Code"
        agrid.Columns.Item(1).TitleObject.Caption = "Religion Name"
...
#Region "CommitTrans"
    Private Sub Committrans(ByVal strChoice As String)
        ...
        If strChoice = "Cancel" Then
            oTemprec.DoQuery("Update [@Z_Religion] set Name=Code where Name Like '%_XD'")
        Else
            oTemprec.DoQuery("Delete from  [@Z_Religion]  where Name Like '%_XD'")
        End If
    ...
    Private Function AddtoUDT1(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If oGrid.DataTable.GetValue(0, intRow) <> "" Or oGrid.DataTable.GetValue(1, intRow) <> "" Then
                ...
                oUserTable = oApplication.Company.UserTables.Item("Z_Religion")
        ...
        For intRow As Integer = 0 To aGrid.DataTable.Rows.Count - 1
            ...
            For intInnerLoop As Integer = intRow To aGrid.DataTable.Rows.Count - 1
                ...
                If strECode = strECode1 And intRow <> intInnerLoop Then
                    oApplication.Utilities.Message("Religion already exists. Code no : " & strECode1, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Religion Then
