Public Class clsJob
    ...
    Private Sub LoadForm()
        ...
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_Job) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_Job, frm_Job)
...
#Region "AddMode"
    Private Sub AddMode(ByVal aForm As SAPbouiCOM.Form)
        ...
        If aForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
            strCode = oApplication.Utilities.getMaxCode("@Z_PAY_JOB", "DocEntry")
...
#Region "Validations"
    Private Function Validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        If oApplication.Utilities.getEdittextvalue(aForm, "8") = "" Then
            oApplication.Utilities.Message("Job Code is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Return False
        End If
        ...
        If aForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
            Dim otemp As SAPbobsCOM.Recordset
            otemp = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            otemp.DoQuery("Select * from [@Z_PAY_JOB] where U_Z_JobCode='" & oApplication.Utilities.getEdittextvalue(aForm, "8") & "'")
        ...
        If oApplication.Utilities.getEdittextvalue(aForm, "10") = "" Then
            oApplication.Utilities.Message("Job Desctiption is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Return False
        End If
...
#End Region
    ...
    Private Sub DeleteRow(ByVal aform As SAPbouiCOM.Form)
        ...
        oMatrix = aform.Items.Item("7").Specific
        oDataSrc_Line = aform.DataSources.DBDataSources.Item("@Z_P")
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Job Then
